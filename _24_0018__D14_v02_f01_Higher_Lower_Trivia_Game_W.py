...
# from __2x__Higher_Lower_Trivia_Game_gamedata__231008 import data
data = [
    {
        'name': 'Instagram',
        'follower_count': 346,
...
def game_on():
    ...
    while True:
        ...
        if hidden_profile_A_follower_count > hidden_profile_B_follower_count and a_or_b_profile_user_pick == "A":
            ...
            print(f"Sorry, but that's incorrect. {profile_name_A} has {hidden_profile_A_follower_count} million subscribers, and {profile_name_B} has {hidden_profile_A_follower_count} million subscribers.")
            game_on = False
